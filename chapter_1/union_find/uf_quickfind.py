...
# This is my personal own initial implementation of UnionFind. This turns out to be what is called the "quick-find" implementation. I have renamed it to include this name.
